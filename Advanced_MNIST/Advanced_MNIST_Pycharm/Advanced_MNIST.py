...
# y = Wx + b
# weights, biases, conv_2d, max_pool
...
# a way to input labels to show model that the correct answer is during training
...
# bias variable to add to each of the 32 featuresb_conv1 = biases_variable([32], 'b_conv1')
...
with tf.Session() as sess:
    ...
    print("test accuracy %g" % accuracy.eval(feed_dict={x_input: mnist_data.test.images,
                                                        y_input: mnist_data.test.labels,
                                                        keep_prob: 1.0}))
