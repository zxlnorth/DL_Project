...
# model.add(Conv2D(64, (3, 3), input_shape=(16, 16, 32), activation='relu', padding='same', kernel_constraint=maxnorm(3)))
# model.add(Conv2D(128, (3, 3), input_shape=(16, 16, 64), activation='relu', padding='same', kernel_constraint=maxnorm(3)))
...
tf.io.write_graph(frozen_graph, '.', 'cifar10.pb', as_text=False)
