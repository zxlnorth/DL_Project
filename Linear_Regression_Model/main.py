...
# const_1 = tf.constant(value=[[1.1, 2.2]],
#                       dtype=tf.float32,
#                       shape=(1, 2),
#                       name='const_1',
#                       verify_shape=True)
#
# const_2 = tf.constant(value=[[3.1, 4.2]],
#                       dtype=tf.float32,
#                       shape=(1, 2),
#                       name='const_1',
#                       verify_shape=True)
...
# print(session.run(fetches=y, feed_dict={x: [2.0, 3.0, 4.0]}))  # since we didn't specify shape here

# Loss functions: actual vs expected outputs
